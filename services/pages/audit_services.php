    ...
    <!-- <div class="container-fluids"> -->
        ...
        <div class="row mt-5 w-100 bg-light solution-container">
            ...
            <div class="col-12 col-md-3 solution-logo">
                ...
                <p style="font-weight: bold; margin-bottom: 10px;">Mr. Pham Tuan Anh</p>
                <img src="https://www.grantthornton.com.vn/globalassets/1.-member-firms/vietnam/vn/images/37.-nguy-quoc-tuan---240x277.jpg" class="p-3 img-fluid" alt="mr-pham-tuan-anh">
            </div>
        </div>
    <!-- </div> -->
