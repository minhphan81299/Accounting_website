    ...
    <div class="container-fluids">
        ...
        <div class="row mt-5 w-100">
            <div class="col-12 col-md-3">
                <?php include "components/horizontal_navbar.php" ?>
            </div>

            <div class="col-12 col-md-6 col-xs-12 container-fluid">
                <h1 class="m-4">Solutions for your business </h1>
            ...
            <div class="col-12 col-md-3 mt-5">
                <img src="imgs/hihi.png" class="pr-3 img-fluid" alt="jennie-kim">
                <p>Hi i am CEO</p>
            </div>
        </div>
    </div>
